...
<head>
    ...
    <title>Surat Rekomendasi Non-MBKM</title>
...
<body style="width: 21cm; height: 29cm; margin: 0px; position: relative;">
    ...
    <div class="px-50 py-50">
        ...
        <section class="px-50">
            ...
            <p class="text-justify lh-1-5 text-indent">Untuk menjadi peserta Program Non-MBKM <span class="bold">{{ $data['program_name'] }}</span> tahun <span class="bold">{{ $data['year'] }}</span> yang diselenggarakan oleh <span class="bold">{{ $data['program_organizer'] }}</span>.</p>
            <p class="text-justify lh-1-5 text-indent">Dengan ini kami menyatakan bahwa yang bersangkutan benar-benar terdaftar sebagai mahasiswa aktif pada program studi <span class="bold">{{ $data['department'] }}</span>, Nama Fakultas tahun akademik <span class="bold">{{ $academicYear }}</span>.</p>
