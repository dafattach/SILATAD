...
<head>
    ...
    <title>Surat Lainnya Pengunduran Diri</title>
...
<body style="width: 21cm; height: 29cm; margin: 0px; position: relative;">
    ...
    <div class="px-50 py-50">
                ...
                <tr>
                    <td class="vertical-align-top" style="width: 50%;">
                        <table>
                            ...
                            <tr>
                                <td class="vertical-align-top">Perihal</td>
                                <td class="vertical-align-top">:</td>
                                <td class="bold underline vertical-align-top">Permohonan Pengunduran Diri</td>
                            </tr>
                        </table>
                    </td>
                    <td>
        ...
        <section class="px-50 mt-20">
            ...
            <p class="text-justify text-indent lh-1-5 mb-0">
                Mengajukan permohonan untuk <span class="bold">Pengunduran Diri</span> pada Tahun Akademik {{ $data['academic_year'] }}, dengan alasan "{{ $data['excuse'] }}". Demikian atas perhatiannya disampaikan terima kasih.
            </p>
        </section>
