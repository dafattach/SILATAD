    ...
    <div class="card shadow-lg border-0 mb-5">
      <div class="card-header bg-gradient-primary text-white">
        <div class="d-flex align-items-center">
          ...
          <div>
            <h3 class="mb-0">Surat Lainnya Transkrip</h3>
              ...
              <tr class="align-middle">
                ...
                <td class="text-center">
                  @if($datum->approved_at)
                    ...
                    @endphp
                    <a href="{{ asset('storage/' . $pdf->transkrip_file_path ?? '') }}" target="_blank" class="btn btn-success btn-sm {{ $pdf->transkrip_file_path ?? null ? '':'disabled' }}">
          ...
          <div class="row mb-4">
            <div class="col-12">
              <h5 class="fw-bold text-success mb-3">
                <i class="bi bi-file-text me-2"></i>Informasi Keperluan
              </h5>
            </div>
            <div class="col-md-6 mb-3">
              ...
              <div class="form-text">
                <i class="bi bi-info-circle me-1"></i>Pilih keperluan pengajuan transkrip.
              </div>
              @error('purpose')
                <div class="invalid-feedback">{{ $message }}</div>
              @enderror
