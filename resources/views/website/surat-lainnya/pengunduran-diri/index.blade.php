    ...
    <div class="card shadow-lg border-0 mb-5">
      <div class="card-header bg-gradient-primary text-white">
        <div class="d-flex align-items-center">
          ...
          <div>
            <h3 class="mb-0">Surat Lainnya Pengunduran Diri</h3>
              ...
              <tr class="align-middle">
                ...
                <td class="text-center">
                  @if($datum->approved_at)
                      <a href="{{ route('surat-lainnya.pengunduran-diri.preview', $datum->id) }}" target="_blank" class="btn btn-success btn-sm">
          ...
          <div class="row mb-4">
            <div class="col-12">
              <h5 class="fw-bold text-info mb-3">
                <i class="bi bi-door-open me-2"></i>Informasi Pengunduran Diri
              </h5>
            </div>
            <div class="col-md-6 mb-3">
              <label class="form-label fw-medium">Alasan Pengunduran Diri <span class="text-danger">*</span></label>
              <input type="text" name="excuse" class="form-control @error('excuse') is-invalid @enderror" value="{{ old('excuse') }}" required>
              <div class="form-text">
                <i class="bi bi-info-circle me-1"></i>Alasan pengunduran diri dari program studi.
              </div>
              @error('excuse')
                <div class="invalid-feedback">{{ $message }}</div>
              @enderror
