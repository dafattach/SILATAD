    ...
    <div class="card shadow-lg border-0 mb-5">
      <div class="card-header bg-gradient-primary text-white">
        <div class="d-flex align-items-center">
          ...
          <div>
            <h3 class="mb-0">Surat Pengantar PKL</h3>
              ...
              <tr class="align-middle">
                ...
                <td class="text-center">
                  @if($datum->approved_at)
                      <a href="{{ route('surat-pengantar.pkl.preview', $datum->id) }}" target="_blank" class="btn btn-success btn-sm">
      ...
      <div class="card-body p-4">
        <form action="{{ route('surat-pengantar.pkl.store') }}" method="post">
            ...
            <div class="col-12 mb-3">
              <div class="card border-secondary">
                <div class="card-header bg-secondary text-white py-2">
                  <h6 class="mb-0"><i class="bi bi-person me-2"></i>Mahasiswa 2</h6>
                </div>
                <div class="card-body">
                  <div class="row">
                    <div class="col-md-6 mb-3">
            ...
            <div class="col-12 mb-3">
              <div class="card border-info">
                <div class="card-header bg-info text-white py-2">
                  <h6 class="mb-0"><i class="bi bi-person me-2"></i>Mahasiswa 3</h6>
                </div>
                <div class="card-body">
                  <div class="row">
                    <div class="col-md-6 mb-3">
            ...
            <div class="col-12 mb-4">
              <div class="card border-warning">
                <div class="card-header bg-warning text-dark py-2">
                  <h6 class="mb-0"><i class="bi bi-person me-2"></i>Mahasiswa 4</h6>
                </div>
                <div class="card-body">
                  <div class="row">
                    <div class="col-md-6 mb-3">
          ...
          <div class="row mb-4">
            ...
            <div class="col-md-4 mb-3">
              <label class="form-label fw-medium">Tanggal Mulai PKL</label>
              <input type="date" name="starting_date" class="form-control @error('starting_date') is-invalid @enderror" value="{{ old('starting_date') }}">
              <div class="form-text">
                <i class="bi bi-info-circle me-1"></i>Masukkan tanggal mulai PKL jika ingin dicantumkan pada surat pengantar.
              </div>
              @error('starting_date')
                <div class="invalid-feedback">{{ $message }}</div>
              @enderror
            ...
            <div class="col-md-4 mb-3">
              <label class="form-label fw-medium">Tanggal Selesai PKL</label>
              <input type="date" name="ending_date" class="form-control @error('ending_date') is-invalid @enderror" value="{{ old('ending_date') }}">
              <div class="form-text">
                <i class="bi bi-info-circle me-1"></i>Masukkan tanggal selesai PKL jika ingin dicantumkan pada surat pengantar.
              </div>
              @error('ending_date')
                <div class="invalid-feedback">{{ $message }}</div>
              @enderror
