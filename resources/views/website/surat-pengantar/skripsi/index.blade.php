    ...
    <div class="card shadow-lg border-0 mb-5">
      <div class="card-header bg-gradient-primary text-white">
        <div class="d-flex align-items-center">
          ...
          <div>
            <h3 class="mb-0">Surat Pengantar Penelitian Skripsi</h3>
              ...
              <tr class="align-middle">
                ...
                <td class="text-center">
                  @if($datum->approved_at)
                      <a href="{{ route('surat-pengantar.skripsi.preview', $datum->id) }}" target="_blank" class="btn btn-success btn-sm">
            ...
            <div class="col-12 mb-3">
              <div class="card border-primary">
                <div class="card-header bg-primary text-white py-2">
                  <h6 class="mb-0"><i class="bi bi-person me-2"></i>Mahasiswa (Pemohon)</h6>
                </div>
                <div class="card-body">
                  <div class="row">
